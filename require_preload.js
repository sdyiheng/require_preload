...
(function (global, setTimeout) {
    ...
    function newContext(contextName) {
        ...
        context = {
            ...
            configure: function (cfg) {
                ...
                if (cfg.preLoadedScripts) {
                    //bind preLoadedScripts
                    for (_url in cfg.preLoadedScripts) {
                        config.preLoadedScripts[_url] = cfg.preLoadedScripts[_url];
                    }
                }
    ...
    req.load = function (context, moduleName, url) {
        ...
        if (isBrowser) {
            ...
            var usePreloadedScript = false;
            if (context.config.preLoadedScripts[url]) {
                node.type = "text/javascript";
                node.text = context.config.preLoadedScripts[url];
                usePreloadedScript = true;
            } else {
            ...
            if (usePreloadedScript) {
                setTimeout(function () {
                    var _moduleName = moduleName;
                    context.completeLoad(_moduleName);
                }, 0);
            }
            return node;
        } else if (isWebWorker) {
